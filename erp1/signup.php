            ...
            <div class="col-md-6 mx-auto">
                <form id="SignupForm" method="post" action="/signup.php">
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                        ...
                        <input type="text" name="username" id="registerUsername" class="form-control" placeholder="Please enter your username" />
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                        ...
                        <input type="email" name="email" id="registerEmail" class="form-control" placeholder="Please enter your email" />
                    </div>

                    <!-- Password input -->
                    <div data-mdb-input-init class="form-outline mb-4">
                        <label class="form-label" for="registerPassword">Password<span class="required">*</span></label>
                        <input type="password" name="password" id="registerPassword" class="form-control" placeholder="Please enter your password" />
